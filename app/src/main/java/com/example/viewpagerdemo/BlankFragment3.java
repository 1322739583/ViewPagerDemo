...
public class BlankFragment3 extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        Log.d("BlankFragment3", "onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d("BlankFragment3", "onPause");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.d("BlankFragment3", "onDestroy");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.d("BlankFragment3", "onDestroyView");
    }
}
